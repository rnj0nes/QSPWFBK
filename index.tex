...
\hypersetup{
  pdftitle={Principles and Practice for Data Analysis in a Supporting and Consulting Environment},
  pdfauthor={QSP Team},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\title{Principles and Practice for Data Analysis in a Supporting and
...
\hypertarget{chapter-1-introduction-to-data-analysis-reports}{%
\chapter{Chapter 1: Introduction to Data Analysis
Reports}\label{chapter-1-introduction-to-data-analysis-reports}}

\hypertarget{principles}{%
\section{1.1 Principles}\label{principles}}
...
\chapter{1.2 Practice}\label{practice}}
